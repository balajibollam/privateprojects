...
<input class="inputReg" placeholder="GenaratePassword " type="password" name="pwd" id="pwd"/><br>
<input class="inputReg" placeholder="Designation" type="text" name="designation" id="designation"/><br>
<input class="inputReg" placeholder="Experiance(Yeras.Months)" type="number" name="experiance" id="experiance"/><br>
